...
- [Configuration](#configuration)
	- [Configuring Recommendable Data](#configuring-recommendable-data)
	- [Modifying the Import Query](#modifying-the-import-query)
- [Importing users/items](#importing-usersitems)
	- [Batch Import via Artisan Command](#batch-import-via-artisan-command)
	- [Batch Import via Programmatically](#batch-import-via-programmatically)
- [Managing Properties](#managing-properties)
	- [Get existing properties](#get-existing-properties)
	- [Creating properties](#creating-properties)
	- [Deleting properties](#deleting-properties)
- [Adding/Updating Records](#addingupdating-records)
	- [Adding via Eloquent Model](#adding-via-eloquent-model)
	- [Adding via Facade](#adding-via-facade)
- [Removing Records](#removing-records)
	- [Removing via Eloquent Model](#removing-via-eloquent-model)
	- [Removing via Facade](#removing-via-facade)
- [Merging Users](#merging-users)
- [List Users/Items](#list-usersitems)
...
- [Reset Database](#reset-database)
	- [Reset via Artisan Command](#reset-via-artisan-command)
	- [Reset via Programmatically](#reset-via-programmatically)
- [Testing](#testing)
- [Changelog](#changelog)
